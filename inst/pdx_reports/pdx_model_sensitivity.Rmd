...
if (nlevels(data_model[[3]]) == 2) {
  ...
  row.names(K) <- c(
    ContRes_ContSen, ContRes_TrtRes, ContSen_TrtSen, interaction
  )
  ...
  ContRes_Trt2Res <- str_c(
    "[", params$control_level, " & ", params$resistant_level, "] - [",
    treatment2_level, " & ", params$resistant_level, "]"
  )
  ContSen_Trt2Sen <- str_c(
    "[", params$control_level, " & ", sensitive_level, "] - [",
  ...
  TrtRes_Trt2Res <- str_c(
    "[", treatment_level, " & ", params$resistant_level, "] - [",
    treatment2_level, " & ", params$resistant_level, "]"
  )
  TrtSen_Trt2Sen <- str_c(
    "[", treatment_level, " & ", sensitive_level, "] - [",
    treatment2_level, " & ", sensitive_level, "]"
  )
  ...
  K <- rbind(
    "ContRes - ContSen"    = c(0, 1, 0, 0, 0, 0),
    "ContRes - TrtRes"     = c(0, 0, 1, 0, 0, 0),
    "ContSen - TrtSen"     = c(0, 0, 1, 0, 1, 0),
    "ContRes - Trt2Res"    = c(0, 0, 0, 1, 0, 0),
    "ContSen - Trt2Sen"    = c(0, 0, 0, 1, 0, 1),
    "sensitivity:Trt"      = c(0, 0, 0, 0, 1, 0),
    "sensitivity:Trt2"     = c(0, 0, 0, 0, 0, 1),
    "sens:Trt - sens_Trt2" = c(0, 0, 0, 0, 1,-1),
    "TrtRes_Trt2Res"       = c(0, 0, 1,-1, 0, 0),
    "TrtSen_Trt2Sen"       = c(0, 0, 1,-1, 1,-1)
  )

  
  row.names(K) <- c(
    ContRes_ContSen, 
    ContRes_TrtRes, ContSen_TrtSen, 
    ContRes_Trt2Res, ContSen_Trt2Sen,
    sensitivity_Trt_interaction, sensitivity_Trt2_interaction,
    difference_interactions, TrtRes_Trt2Res
  )
